...
# Função para estilização dos botões da interface
...
top10 = pd.read_csv('./csv/top10_vendas_globais.csv')
top10negative = pd.read_csv('./csv/top10_menores_vendas_globais.csv')
top5empresas = pd.read_csv('./csv/top5_empresas_maiores_vendas.csv')
top10anos = pd.read_csv('./csv/top10_anos_com_mais_vendas.csv')
generos = pd.read_csv('./csv/vendas_por_genero.csv')
generos_medias = pd.read_csv('./csv/vendas_medias_por_genero.csv')
decadas = pd.read_csv('./csv/vendas_por_decada.csv')
regioes = pd.read_csv('./csv/vendas_por_regiao.csv')
jogos_por_ano = pd.read_csv('./csv/jogos_por_ano.csv')
jogos_por_decada = pd.read_csv('./csv/jogos_por_decada.csv')
top3_generos_mais_lucrativos = pd.read_csv('./csv/top3_generos_mais_lucrativos.csv')
...
botao("Vendas Totais por Gênero", command=vendas_por_genero)
botao("Vendas Médias por Gênero", command=vendas_medias_por_genero)
botao("Vendas por Década", command=vendas_por_decada)
botao("Vendas por Região", command=vendas_por_regiao)
botao("Top 3 Gêneros Mais Lucrativos", command=top3_mais_lucrativos)
